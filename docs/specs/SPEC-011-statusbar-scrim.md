...
status: done（代码随 PR #30 / v74 发布）— ✅ **真机截图验证环已于 2026-07-26 关闭**：维护者提供 standalone 滚动态亮暗各一张，系统状态栏底下不再有应用文字穿过。同一批截图暴露的遮条底缘硬切字形，已由 v76 的 10px 渐变收尾。本文件头此前一直停在「验证环仍开着」，2026-08-03 补正。
owner: 执行方认领后填分支名
